...
2. Run the [deploy script](https://raw.githubusercontent.com/etnpoolorg/nodejs-pool/master/deployment/deploy_electroneum.bash) as a **NON-ROOT USER**.  This is very important!  This script will install the pool to whatever user it's running under!  Also.  Go get a coffee, this sucker bootstraps the monero installation.
Install Script: curl -L https://raw.githubusercontent.com/etnpoolorg/nodejs-pool/master/deployment/deploy_electroneum.bash | bash
...
Install Script:
```bash
curl -L https://raw.githubusercontent.com/etnpoolorg/nodejs-pool/master/deployment/deploy_electroneum.bash | bash
```
